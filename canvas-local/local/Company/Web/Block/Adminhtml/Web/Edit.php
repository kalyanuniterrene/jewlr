...
class Company_Web_Block_Adminhtml_Web_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
       ...
       $this->_addButton('saveandcontinue1', array(
            'label'     => Mage::helper('adminhtml')->__('Import'),
            'onclick'   => 'saveAndContinueEdit1()',
            'class'     => 'save',
            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/import/id/'.Mage::registry('web_data')->getId()) . '\')',
        ), -100);

       $this->_addButton('saveandcontinue2', array(
            'label'     => Mage::helper('adminhtml')->__('Update The Values'),
            'onclick'   => 'saveAndContinueEdit2()',
            'class'     => 'save',
            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/customupdate/id/'.Mage::registry('web_data')->getId()) . '\')',
        ), -100);
...
// /'setLocation(\' '  .  $this->getUrl('*/*/import', array('param' => 'value')) . '\')'
