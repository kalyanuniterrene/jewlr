...
<?php
	...
	{ 
		   $folder_Name=$_GET['name'];/*Get The Name of the folder*/
			...
			mkdir("media/Lifestyle/".$folder_Name, 0777);
			
			define('DIRECTORY', '/home/willowandhall.co.uk/public_html/media/Lifestyle/'.$folder_Name."/");
			...
			$_product = Mage::getModel('catalog/product')->loadByAttribute('sku', $csv_Name);
			...
			$simple_collection = $conf->getUsedProductCollection()->addAttributeToSelect('*')->addFilterByRequiredOptions();
				...
				{
			//if(substr_count(strtolower($simple_product->getSku()),'Two')>0)
