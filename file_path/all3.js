...
var CurvedText = (function() {
    ...
    */
    CurvedText.prototype._forceGroupUpdate = function() {
      ...
      this.group.left = 154.19402985074618;
      this.group.top = 317.41293532338324;
      this.group.width = 205.00492635846805;
      
      /*this.group.currentWidth = 173.4555747694377;
      this.group.currentHeight = 25.896702229525328;
      this.group.left = 206.9376719223484;*/
...
jQuery('.eng1').click(function(){
  ...
  createImage();
     ...
     jQuery('.fancy-image4').attr('old-url',jQuery('fancy-image3').attr('src'));

      jQuery('.fancy-image4').attr('src',newsrc);
