...
var CurvedText = (function() {
    ...
    */
    CurvedText.prototype._forceGroupUpdate = function() {
      ...
      //alert(this.group.currentHeight);
      this.opts.angle = -0;
      ...
      this.group.currentWidth = 170.96142865371425;
      this.group.height = 44.6074339267185;
      this.group.currentHeight = 27.02078252017011;
      this.group.left = 120;
      this.group.top =  260;
...
jQuery('.eng1').click(function(){
  ...
  createImage();
     ...
     jQuery('.fancy-image2').attr('old-url',jQuery('fancy-image2').attr('src'));

      jQuery('.fancy-image2').attr('src',newsrc);
