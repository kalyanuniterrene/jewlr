...
var CurvedText = (function() {
    ...
    */
    CurvedText.prototype._forceGroupUpdate = function() {
      ...
      this.group.left = 129.94527363184079;
...
jQuery('.eng1').click(function(){
  ...
  createImage();
     ...
     jQuery('.fancy-image3').attr('old-url',jQuery('fancy-image3').attr('src'));

      jQuery('.fancy-image3').attr('src',newsrc);
