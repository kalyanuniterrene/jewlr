...
var CurvedText = (function() {
    ...
    */
    CurvedText.prototype._forceGroupUpdate = function() {
      ...
      this.group.set("angle",310.72195811906136 );
      this.group.scaleX = 0.9348010887618413;
      this.group.scaleY = 0.555702651905065;
      
      this.group.currentWidth = 194.55341456697252;
      this.group.height = 30.50891689804312;
      this.group.currentHeight = 27.386064998855446;
      this.group.left = 125.94527363184079;
      this.group.top = 309.92537313432837;
    ...
    */
    CurvedText.prototype._render = function() {
        ...
        /*}*/
        this.opts.angle = this.group.get("angle");
  ...
  var original = canvas.getActiveObject();
    ...
    */
    ...
    if(n>10 && n<=16){
      ...
      Example.center();
      Example.set( 'reverse', true ) ;
      Example.set( 'top', 254.38008285391533 ) ; 
      Example.set( 'spacing', 6 ) ; 
      Example.set( 'left', 228.81919299939238 ) ; 
      Example.set( 'radius', 130 ) ; 
      Example.set( 'width', 164.61211766059714 ) ; 
...
jQuery('.eng1').click(function(){
  ...
  createImage();
     ...
     jQuery('.fancy-image5').attr('old-url',jQuery('fancy-image3').attr('src'));

      jQuery('.fancy-image5').attr('src',newsrc);
