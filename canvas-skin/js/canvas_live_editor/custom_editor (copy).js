$(function() {
    ...
    var canvas_background = { image: 'http://localhost/cs_magento/live/Magento-Code/skin/frontend/rwd/default/images/canvas_live_editor/images/bg3.jpg', text: 'DRAG PHOTO HERE', opacity: 1 };
    ...
    jQuery('.image.canvasWrap')
          .append(
            '<div class="d_view_wraper">'+
                '<div class="d_sides top"><img src=""></div>'+
                '<div class="d_sides left"><img src=""></div>'+
                '<div class="d_sides bottom"><img src=""></div>'+
                '<div class="d_sides right"><img src=""></div>'+
                '<div class="d_sides front"><img src=""></div>'+
            '</div>'
          );
    ...
    function make_base() {
        ...
        // imgElement.src = canvas_background.image;
