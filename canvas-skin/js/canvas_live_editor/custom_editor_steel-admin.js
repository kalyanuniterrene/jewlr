$(function() {
   ...
   // }));
    ...
    jQuery(document).on('click', '.save_it', function(e) {
        ...
        var svg = main_Editarea.toJSON();

        var orderData_url = jQuery('#orderData').attr('data-url');
        var order_img_src = svg;
        
        var myJSON = JSON.stringify(svg);
        
        jQuery('#finalJson').val(myJSON);
    ...
    jQuery(document).on('click', '.saveCanvas', function(e) {
        ...
        var finalJson = jQuery('#finalJson').val();
        ...
        $.ajax({
            url: saveData.url,
            data: { saved_name: saved_name, finalJson: finalJson},
            type: "POST",
            success: function(response) {
                jQuery('#savedJSONdata').val(response);
                console.log(response);
    ...
    jQuery(document).on('click', '.saveCanvasJson', function(e) {
...
function add_method(argument) {
  ...
  function add_to_invoice_fixing_methods(selectedValue) {
    ...
    /*Added New Code For Text BOx*/
    
    jQuery('.steel_admin_width').on('keyup', function(argument) {
    ...
    jQuery('.steel_admin_height').on('change', function(argument) {
        var d_datas = { dataW: undefined, dataH: undefined };
        d_datas.dataH = jQuery(this).val();
        d_datas.dataW = jQuery(this).siblings().val();
        setTheValue(d_datas);
