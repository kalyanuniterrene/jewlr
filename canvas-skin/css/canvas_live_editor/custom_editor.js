$(function() {
    ...
    var canvas_background = { image: 'http://onlinedevserver.biz/dev/canvassignages-v6/skin/frontend/rwd/default/images/canvas_live_editor/images/bg3.jpg', text: 'DRAG PHOTO HERE', opacity: 1 };
   ...
   // jQuery('.image.canvasWrap').draggable({ axis: "x"});
    ...
    jQuery(document).on('click', function(e) {
        ...
        if (!jQuery(e.target).is('.image.canvasWrap canvas, .image.canvasWrap canvas *')) {
    ...
    jQuery('.canvasWrap').append('<div class="loading_img" ><img src="http://onlinedevserver.biz/dev/canvassignages-v6/skin/frontend/rwd/default/images/canvas_live_editor/images/loading.gif" alt=""></div>');
    ...
    jQuery(document).on('click', '#order_now', function(argument) {
        ...
        var svg = main_Editarea.toDataURLWithMultiplier('svg', 5);
