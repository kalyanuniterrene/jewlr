...
<?php /*?>			<p><?php _e( 'Registering for this site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'buddypress' ); ?></p>
<?php */?>
			<?php
						...
						<div<?php bp_field_css_class( 'editfield' ); ?>>
							...
							if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
								<p class="field-visibility-settings-toggle" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
									...
									?><?php */?>
									<a href="#" class="visibility-toggle-link"><?php _ex( '', 'Change profile field visibility level', 'buddypress' ); ?></a>
								</p>
