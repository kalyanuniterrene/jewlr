...
<?php
  ...
  <div class="container">
        <div class="banner_div">
            ...
            <a href="#" class="view_btn">VIEW PRODUCTS <img src="<?php bloginfo('template_url')?>/images/btn_aorow.png" alt="#"></a>
        </div>
	</div>
     <?php
   endwhile;
...
<section class="feature_sec">
    ...
    width: 90%;
    margin: 0 auto;
    margin-top: 16px;"><?php the_title()."<br/>"; ?></h5>
                                <h4 style="margin-top:10px;"><?php echo $product->get_price_html(); ?></h4>
                               
                                <a style="margin-top: 10px;"href="<?php echo get_permalink( $loop->post->ID ) ?>" class="view_btn"><img src="<?php bloginfo('template_url')?>/images/cart_icon2.png" alt="#"> SHOP NOW</a>
							</div>
