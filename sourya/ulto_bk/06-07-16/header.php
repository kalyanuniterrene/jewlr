                ...
                <div class="col-md-8  col-sm-8 col-xs-12">
                	<div class="topHeaderNavs">
                    	<ul class="list-inline pull-right">
                        	<li><a href="<?php echo WC()->cart->get_cart_url(); ?>">Shopping(<?php echo WC()->cart->get_cart_contents_count()?>) <img src="<?php bloginfo('template_url')?>/img/shopping_bag_icon.png"/></a></li>
