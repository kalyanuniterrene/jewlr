 ...
 foreach ($all_categories as $cat) {
    ...
    if($cat->category_parent == 0) {
        ...
        if($sub_cats) {
           ...
           <?php /*?> <a href="<?php echo get_term_link($sub_category->slug, 'product_cat') ?>"><?php */?>
...
<div class="col-md-3 col-sm-3 col-xs-12 links">
                  ...
                  <a href="<?php echo get_site_url() ?>/accessories">  <h2>Accessories</h2>

                </div>
                
                 <div class="col-md-3 col-sm-3 col-xs-12 links">

                  <a href="<?php echo get_site_url() ?>/become-an-uber-driver">  <h2>Become an Uber Driver</h2>

                </div>
                 <div class="col-md-3 col-sm-3 col-xs-12 links">

                  <a href="<?php echo get_site_url() ?>/driver-kits">  <h2>Driver Kits</h2>

                </div>
                 <div class="col-md-3 col-sm-3 col-xs-12 links">

                  <a href="<?php echo get_site_url() ?>/sale">  <h2>Sale</h2>
