...

		{
			...
			if($option_title == $opt_title)
			{
				...
				foreach ($values as $k => $v) 
				{
					...
					$option_id=$ipt_title['option_type_id'];
					$parent_id_org=$ipt_title['option_id'];;
					...
					$product_data_arr[$j]['option_id'] =$option_id;
					$product_data_arr[$j]['parent_id'] =$parent_id_org;
